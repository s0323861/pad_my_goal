    ...
    if($tmp2 == 0){
      ...
      <li class="list-group-item">
        ...
        <div class="input-group">
          ...
          <button type="submit" class="btn btn-primary" name="button" value="done" data-toggle="tooltip" data-placement="top" title="" data-original-title="達成"><span class="glyphicon glyphicon-ok"></span></button>
          <button type="submit" class="btn btn-warning" name="button" value="refresh" data-toggle="tooltip" data-placement="top" title="" data-original-title="更新"><span class="glyphicon glyphicon-refresh"></span></button>
          <button type="submit" class="btn btn-danger" name="button" value="delete" data-toggle="tooltip" data-placement="top" title="" data-original-title="削除"><span class="glyphicon glyphicon glyphicon-trash"></span></button>
          </span>
        </div>
        </div>
        </fieldset>
    ...
    # 完了したTODOの表示部分を作成
      ...
      <li class="list-group-item">
        ...
        <div class="input-group">
          ...
          <span class="input-group-btn">
          <button type="submit" class="btn btn-primary" name="button" value="return" data-toggle="tooltip" data-placement="top" title="" data-original-title="元に戻す"><i class="fa fa-reply"></i></button>
          </span>
        </div>
        </form>
      </li>
...
<div class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    ...
    <a href="./" class="navbar-brand"><i class="fa fa-list-alt"></i> パズドラ目標管理ツール</a>
  ...
  <div class="row">
    ...
    <div class="col-lg-12">
      <div class="well input-group">
        <input type="text" name="todo" class="form-control" placeholder="目標の追加" required>
        <input type="hidden" name="nickname" value="$nickname">
        <input type="hidden" name="flag" value="0">
        <span class="input-group-btn">
...
$tag1
          ...
          <span class="glyphicon glyphicon-ok"></span> 達成した目標
...
$tag2
  ...
  <div class="row">
    <div class="col-lg-12">
    <p>Copyright (C) 2016 <a href="http://tsukuba42195.top/">Akira Mukai</a><br>
